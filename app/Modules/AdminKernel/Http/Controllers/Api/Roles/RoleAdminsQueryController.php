...
use Maatify\AdminKernel\Domain\List\RoleAdminsCapabilities;
...
final readonly class RoleAdminsQueryController
{
    public function __construct(
        private RoleAdminsRepositoryInterface $reader,
    ...
    public function __invoke(
        ...
        // 3) capabilities
        $capabilities = RoleAdminsCapabilities::define();

        // 4) resolve filters
        $resolved = $this->filters->resolve($query, $capabilities);

        // 5) execute reader
        $result = $this->reader->queryAdminsForRole($roleId, $query, $resolved);
