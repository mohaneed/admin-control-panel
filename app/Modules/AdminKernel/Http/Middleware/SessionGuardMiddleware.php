...
class SessionGuardMiddleware implements MiddlewareInterface
{
    ...
    public function process(ServerRequestInterface $request, RequestHandlerInterface $handler): ResponseInterface
    {
        ...
        } catch (\Maatify\AdminKernel\Domain\Exception\InvalidSessionException | \Maatify\AdminKernel\Domain\Exception\ExpiredSessionException | \Maatify\AdminKernel\Domain\Exception\RevokedSessionException $e) {
